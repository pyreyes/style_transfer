...
def read_nmt_data(src, config, tgt, attribute_vocab, train_src=None, train_tgt=None,
    ...
    src_lines, src_content, src_attribute = list(zip(
        *[extract_attributes(line, pre_attr) for line in src_lines] #Changed this line from original code
    ))
    ...
    tgt_lines, tgt_content, tgt_attribute = list(zip(
        *[extract_attributes(line, post_attr) for line in tgt_lines] #changed this line from original code
    ))
